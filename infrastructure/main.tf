        ...
        var.google_ai_api_key != "" ? [
          {
            ...
            valueFrom = aws_ssm_parameter.google_ai_api_key[0].arn
          }
        ] : [],
        var.openai_api_key != "" ? [
          {
            name      = "OPENAI_API_KEY"
            valueFrom = aws_ssm_parameter.openai_api_key[0].arn
          }
        ] : []
      )
    ...
    Statement = [
      {
        ...
        Resource = concat(
          var.google_ai_api_key != "" ? [aws_ssm_parameter.google_ai_api_key[0].arn] : [],
